			...
			<section class="restaurant-detail-header">
					...
					<div class="restaurant-detail">
						...
						<div class="restaurant-info">
							...
							${dinner.dinnerOpen} ~ ${dinner.dinnerClose}</span><br />
							<i class="fa-solid fa-phone"></i>
								<span id="phone">${dinner.dinnerPhone}</span><br /> 
								<i class="fa-solid fa-car"></i>
								<span id="parking">${dinner.dinnerParking}</span><br />
						</div>
	...
	<section class="restaurant-detail-info">
		<div class="restaurant-detail-menu">
			<input id="information" type="radio" name="tab-item" checked /> <label
				...
				id="review" type="radio" name="tab-item" /> <label class="tab-item"
				for="review" onclick="showContent('review-content')">리뷰</label> <input
				id="picture" type="radio" name="tab-item" /> <label
				class="tab-item" for="picture"
				onclick="showContent('picture-content')">사진</label> <input
				id="around" type="radio" name="tab-item" /> <label class="tab-item"
				for="around" onclick="showContent('around-content')">주변</label>
		</div>
