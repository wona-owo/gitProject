...
.delete {
    display: flex; /* Added for centering content inside the button */
	...
	<section class="section update-wrap">
		...
		<form method="post" action="/member/update"
			...
			<div class="input-wrap">
				...
				<div class="input-item">
					<input type="hidden" id="zipp_code_id" name="zipp_code"
						maxlength="10" placeholder="우편번호"> <input type="text"
						name="memberAddr" id="memberAddr" maxlength="40"
						value="${loginMember.memberAddr}" placeholder="기본 주소를 입력하세요"
						required>
			...
			<div class="delete-button">
				<a href="/member/delete" class="delete">회원 탈퇴</a>
			</div>
		</form>
	</section>
			...
			for ( let key in checkObj) {
				...
				if (checkObj[key + "Changed"] && !checkObj[key]) {
					...
					case "memberPwConfirm":
						str = "비밀번호 확인 형식이 유효하지 않습니다";
						break;
					case "memberName":
						str = "이름 형식이 유효하지 않습니다";
						break;
					case "memberPhone":
