...
-- tbl_menu 데이터
insert into tbl_menu values ('d2411190004', 'f2411190001', 18000);
insert into tbl_menu values ('d2411190003', 'f2411190002', 12000);
insert into tbl_menu values ('d2411190003', 'f2411190003', 20000);
insert into tbl_menu values ('d2411190004', 'f2411190004', 15000);
insert into tbl_menu values ('d2411190005', 'f2411190005', 13000);
insert into tbl_menu values ('d2411190005', 'f2411190001', 7000);
...
-- 즐겨찾기
insert into tbl_like values ('d2411190001', 'm2411190002');
insert into tbl_like values ('d2411190002', 'm2411190002');
insert into tbl_like values ('d2411190003', 'm2411190003');
...
insert into tbl_book values ( 'b' || to_char (sysdate, 'yymmdd') || lpad (seq_book.nextval, 4, '0'), 'd2411190001', 'm2411190002', to_date ('24/11/06', 'yy/mm/dd'), '1230', 4);
insert into tbl_book values ( 'b' || to_char (sysdate, 'yymmdd') || lpad (seq_book.nextval, 4, '0'), 'd2411190001', 'm2411190001', to_date ('24/11/15', 'yy/mm/dd'), '1230', 4);
insert into tbl_book values ( 'b' || to_char (sysdate, 'yymmdd') || lpad (seq_book.nextval, 4, '0'), 'd2411190001', 'm2411190002', to_date ('24/11/15', 'yy/mm/dd'), '1245', 4);
insert into tbl_book values ( 'b' || to_char (sysdate, 'yymmdd') || lpad (seq_book.nextval, 4, '0'), 'd2411190001', 'm2411190003', to_date ('24/11/15', 'yy/mm/dd'), '1800', 4);
insert into tbl_book values ( 'b' || to_char (sysdate, 'yymmdd') || lpad (seq_book.nextval, 4, '0'), 'd2411190001', 'm2411190001', to_date ('24/11/15', 'yy/mm/dd'), '1830', 4);
insert into tbl_book values ( 'b' || to_char (sysdate, 'yymmdd') || lpad (seq_book.nextval, 4, '0'), 'd2411190001', 'm2411190002', to_date ('24/11/15', 'yy/mm/dd'), '1900', 4);
insert into tbl_book values ( 'b' || to_char (sysdate, 'yymmdd') || lpad (seq_book.nextval, 4, '0'), 'd2411190001', 'm2411190003', to_date ('24/12/25', 'yy/mm/dd'), '1800', 4);
...
select * from tbl_dinner d left join tbl_like l on (d.dinner_no = l.dinner_no) where l.member_no = 'm2411190002';
